...
Links that navigate a user through the Knowledgebase site can follow the normal Markdown syntax. All links that navigate a user away from the Knowledgebase site should have `{target=new}` appended - this opens the link in a new tab.
